...
export class Tab2Page {
	...
	constructor(public navCtl: NavController, public pls: PlacesService, public modalController: ModalController, public userService: UserServiceService, public auth: AngularFireAuth) {
